...
function Card(props){
    ...
    return(
    <div className="w-full max-w-sm bg-white border border-gray-200 m-4 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className="flex flex-col items-center pb-10">
            ...
            <div className="flex mt-4 md:mt-6">
                <a href={ props.enCours===false ? `/details/${props.rendezVous.patient._id}/${false}`
                :`/details/${props.rendezVous.patient._id}/${true}`} className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Consulter les details</a>
